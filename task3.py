# читаем файл
# строки расщепляем по пробелу на три части занося в список
# дальше этот список анализируем по баллам
# результат записываем во второй файл
...
def read_list(my_file_name):
    ...
    with open(my_file_name, 'r', encoding='utf-8') as f:
        ...
        list_count = int(*rows_list[0].split()) # заданное количество баллов
